Public Class _21_STUDENT_LST
    ...
    Private Sub _21_STUDENT_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        TitleCenter()
    ...
    End Sub
    Private Sub _21_STUDENT_LST_Resize(sender As Object, e As EventArgs) Handles MyBase.Resize
        TitleCenter()
    End Sub
